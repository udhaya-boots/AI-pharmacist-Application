...
const PrescriptionInfoList = ({ prescriptions,setAlertMessage,setPrescriptions,setShowAlert,setType }) => {
        ...
        const updatedPatient = prescriptions.find((pr) => pr._id === id);
        
        setPrescriptions(updatedPrescriptions);
        setType('success');
        setAlertMessage(`${updatedPatient?.patientName+'`s' || 'the patient'}Prescription updated successfully!`);
        setShowAlert(true);
    };
...
export default PrescriptionInfoList;