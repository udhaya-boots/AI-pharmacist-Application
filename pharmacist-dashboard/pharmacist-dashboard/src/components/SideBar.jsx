...
const SideBar = ({ loggedIn }) => {
    ...
    const { pharmacist, logout, isAuthenticated } = usePharmacist();
            ...
            <aside className="w-72 bg-indigo-900 text-white p-8 flex flex-col">
                ...
                <nav className="space-y-6 flex flex-col text-lg flex-1">
                    ...
                    <button 
                        ...
                        className="flex items-center space-x-3 hover:text-red-300 transition-colors duration-200 text-left mt-auto"
                    >
                        <LogOut size={20} />
                        <span>Logout</span>
                    </button>
